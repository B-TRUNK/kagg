...
#  on reddit.com. Run the cell below to load a dataframe of products mentioned
#  on the /r/gaming subreddit and another dataframe for products mentioned on the r//movies subreddit.
"""
...
#ombined_products = pd.concat([gaming_products, movie_products])


#The Powerlifting Database dataset on Kaggle includes one CSV table for powerlifting meets
